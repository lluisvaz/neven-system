  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Button size="sm" className="rounded-sm"><Plus className="w-3.5 h-3.5 mr-2" />Novo Contrato</Button>
      </div>
        ...
        <Table>
          <TableHeader className="bg-muted/50">
            <TableRow className="hover:bg-transparent">
              <TableHead className="font-medium text-xs uppercase tracking-wider h-10 w-28">ID</TableHead>
              <TableHead className="font-medium text-xs uppercase tracking-wider h-10">Cliente / Escopo</TableHead>
              <TableHead className="font-medium text-xs uppercase tracking-wider h-10">Vigência</TableHead>
          ...
          <TableBody>
            {contracts.map(c => (
              <TableRow key={c.id} className="hover:bg-muted/30 transition-colors">
                <TableCell className="text-sm font-mono py-3 text-muted-foreground">{c.id}</TableCell>
                ...
                <TableCell className="py-3 text-sm font-mono font-medium text-right">{c.value}</TableCell>

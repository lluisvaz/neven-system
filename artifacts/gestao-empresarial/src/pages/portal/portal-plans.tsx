...
const clientLocale = { currency: "BRL", currencySymbol: "R$", country: "🇧🇷" };

const currentPlan = {
  name: "Enterprise",
  value: "R$ 12.000,00",
  period: "/mês",
  addons: [{ name: "Módulo Analytics", price: "R$ 3.500,00" }],
  total: "R$ 15.500,00",
...
const availablePlans = [
  {
    ...
    value: "R$ 1.800,00",
    period: "/mês",
    features: ["Até 5 usuários", "CRM básico", "Cobranças", "Suporte por e-mail"],
    current: false,
  },
  {
    name: "Pro",
    value: "R$ 5.200,00",
    period: "/mês",
    features: ["Até 15 usuários", "CRM completo", "ERP financeiro", "Automações básicas", "API limitada", "Suporte prioritário"],
    current: false,
  },
  {
    name: "Enterprise",
    value: "R$ 12.000,00",
    period: "/mês",
    features: ["Usuários ilimitados", "CRM completo", "ERP financeiro", "Automações avançadas", "API completa", "Suporte prioritário", "SLA 4h", "Gerente de conta"],
    current: true,
  },
];
        ...
        <div className="bg-muted/30 p-6 border-b border-border flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Contrato vigente de {currentPlan.contractStart} a {currentPlan.contractEnd}
            </p>
          </div>
          <div className="text-right">
            <p className="text-sm text-muted-foreground uppercase tracking-wider font-medium">Total Mensal ({clientLocale.currencySymbol})</p>
            ...
            <div className="space-y-3">
              ...
              <div className="pt-3 mt-3 border-t border-border flex justify-between items-center">
                ...
                <div className="text-xs text-muted-foreground font-mono">
                  {currentPlan.billing} · {currentPlan.method}
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="pt-6 border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {availablePlans.map((plan, i) => (
            <div
              key={i}
              className={`flex flex-col border rounded-sm bg-card overflow-hidden transition-all ${
                plan.current ? "border-accent ring-1 ring-accent" : "border-border"
              }`}
            >
              {plan.current && (

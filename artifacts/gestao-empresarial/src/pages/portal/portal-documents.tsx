        ...
        <Table>
          <TableHeader className="bg-muted/50">
            <TableRow className="hover:bg-transparent">
              ...
              <TableHead className="font-medium text-xs uppercase tracking-wider h-10">Tamanho</TableHead>
          ...
          <TableBody>
            {documents.map((doc) => (
              <TableRow key={doc.id} className="hover:bg-muted/30 transition-colors group cursor-pointer">
                ...
                <TableCell className="py-4 text-sm font-mono text-muted-foreground">{doc.size}</TableCell>
                <TableCell className="py-4 text-sm font-mono text-muted-foreground">{doc.date}</TableCell>
